                ...
                <div class="col-sm-12 col-md-5">
                    ...
                    <form class="user">
                      <div class="form-group row">
                        <div class="col-sm-4">
                            <a href="#">
                                <img id="newCommitteeImage" onclick="document.querySelector('#newCommitteeLogo').click()" class="img-profile rounded-circle m-auto" style="height: 80px; width: 80px" src="{{ asset('template/image/undraw_posting_photo.svg')}}">
                            </a>
                            {{-- <span class="mr-2 d-none d-lg-inline text-gray-600 small">Logo</span> --}}
                          <input type="file" class="form-control form-control-user d-none" id="newCommitteeLogo" placeholder="Logo">
                        </div>
                        <div class="col-sm-8 mb-3 mb-sm-0">
                          <input type="text" class="form-control form-control-user" id="newCommitteeName" placeholder="Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                          <div class="col-sm-12">
                            <textarea class="w-100" id="newCommitteeDescription">About Committee</textarea>
                          </div>
                      </div>
                      <div class="form-group row">
                          <div class="col-sm-12">
              ...
              <!-- Update Modal-->
                <div class="modal fade" id="m1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">Update {Worship Committee}</h5>
                                ...
                                <div class="col-sm-12">
                                    <form class="user" action="#" method="POST">
                                      <div class="form-group row">
                                        <div class="col-sm-4">
                                            <a href="#">
                                                <img id="updateCommitteeImage_m1" onclick="document.querySelector('#updateCommitteeLogo_m1').click()" class="img-profile rounded-circle m-auto" style="height: 50px; width: 50px" src="{{ asset('template/image/undraw_posting_photo.svg')}}">
                                            </a>
                                          <input type="file" class="form-control form-control-user d-none" id="updateCommitteeLogo_m1" placeholder="Logo">
                                        </div>
                                        <div class="col-sm-8 mb-sm-0">
                                          <input type="text" class="form-control form-control-user" id="updateCommitteeName_m1" placeholder="Name">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                          <div id="" class="col-sm-12 sample">
                                            <textarea  cols="60" class="form-control form-control-user" id="updateCommitteeDescription_m1">About Committee</textarea>
                                          </div>
                                      </div>
                                      <div class="form-group row">
                                          <div class="col-sm-12">
