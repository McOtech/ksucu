                ...
                <div class="col-sm-12 col-md-5">
                    ...
                    <form class="user">
                      <div class="form-group row">
                        <div class="col-sm-4">
                            <a href="#">
                                <img id="newMinistryImage" onclick="document.querySelector('#newMinistryLogo').click()" class="img-profile rounded-circle m-auto" style="height: 80px; width: 80px" src="{{ asset('template/image/undraw_posting_photo.svg')}}">
                            </a>
                            {{-- <span class="mr-2 d-none d-lg-inline text-gray-600 small">Logo</span> --}}
                          <input type="file" class="form-control form-control-user d-none" id="newMinistryLogo" placeholder="Logo">
                        </div>
                      ...
                      <div class="form-group row">
                          <div class="col-sm-12">
                            <textarea class="w-100" id="newMinistryDescription">About Ministry</textarea>
                          </div>
                      </div> <!--onclick="alert(document.querySelector('#newMinistryDescription').value)"-->
                      <div class="form-group row">
                          <div class="col-sm-12">
              ...
              <!-- Update Modal-->
                <div class="modal fade" id="m1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">Update {Praise and Worship}</h5>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <form class="user" action="#" method="POST">
                                      <div class="form-group row">
                                        <div class="col-sm-4">
                                            <a href="#">
                                                <img id="updateMinistryImage_m1" onclick="document.querySelector('#updateMinistryLogo_m1').click()" class="img-profile rounded-circle m-auto" style="height: 50px; width: 50px" src="{{ asset('template/image/undraw_posting_photo.svg')}}">
                                            </a>
                                          <input type="file" class="form-control form-control-user d-none" id="updateMinistryLogo_m1" placeholder="Logo">
                                        </div>
                                        <div class="col-sm-8 mb-sm-0">
                                          <input type="text" class="form-control form-control-user" id="updateMinistryName_m1" placeholder="Name">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                          <div id="" class="col-sm-12 sample">
                                            <textarea  cols="60" class="form-control form-control-user" id="updateMinistryDescription_m1">About Ministry</textarea>
                                          </div>
                                      </div>
                                      <div class="form-group row">
                                          <div class="col-sm-12">
